...
class ErrorMessage {
    ...
    public $Key_Error = array('status'=>409, 'message' => 'Key is invalid');
    public $Key_Missing = array('status'=>409, 'message' => 'Pls Provide key first');
    public $Post_Request_Error = array('status'=>204, 'message' => 'Use Post for this request');
    // public $AllOOK = array("Status"=>200);
